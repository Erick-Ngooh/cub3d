...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   raycasting_utils_bis.c                             :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: engooh <engooh@student.42.fr>              +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/11/19 06:46:30 by engooh            #+#    #+#             */
/*   Updated: 2022/11/19 06:46:40 by engooh           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    set_cast_ray(t_global *g, float rayangle, int i)
{
